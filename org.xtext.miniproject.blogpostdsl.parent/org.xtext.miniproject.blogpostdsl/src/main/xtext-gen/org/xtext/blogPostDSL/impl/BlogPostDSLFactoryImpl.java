...
public class BlogPostDSLFactoryImpl extends EFactoryImpl implements BlogPostDSLFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case BlogPostDSLPackage.SUB_ITEM_ELEMENT: return createSubItemElement();
   ...
   * @generated
   */
  public SubItemElement createSubItemElement()
  {
    SubItemElementImpl subItemElement = new SubItemElementImpl();
