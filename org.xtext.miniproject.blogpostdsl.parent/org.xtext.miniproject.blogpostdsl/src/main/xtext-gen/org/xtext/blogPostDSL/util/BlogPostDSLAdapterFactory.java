...
public class BlogPostDSLAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected BlogPostDSLSwitch<Adapter> modelSwitch =
    new BlogPostDSLSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseSubItemElement(SubItemElement object)
      {
        return createSubItemElementAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.blogPostDSL.SubItemElement <em>Sub Item Element</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createSubItemElementAdapter()
  {
    return null;
  }
