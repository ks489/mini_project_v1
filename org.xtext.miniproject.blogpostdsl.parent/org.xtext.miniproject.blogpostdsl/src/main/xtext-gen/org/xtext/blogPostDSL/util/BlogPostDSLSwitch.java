...
public class BlogPostDSLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case BlogPostDSLPackage.SUB_ITEM_ELEMENT:
      {
        SubItemElement subItemElement = (SubItemElement)theEObject;
        T result = caseSubItemElement(subItemElement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case BlogPostDSLPackage.TITLE:
      {
        ...
        if (result == null) result = caseBlog(title);
        if (result == null) result = caseArticle(title);
        if (result == null) result = caseSubItemElement(title);
        if (result == null) result = caseItemElement(title);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case BlogPostDSLPackage.DATE:
      {
        ...
        if (result == null) result = caseSubItemElement(date);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case BlogPostDSLPackage.TAGS:
      {
        ...
        if (result == null) result = caseSubItemElement(tags);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Sub Item Element</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Sub Item Element</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSubItemElement(SubItemElement object)
  {
    return null;
  }
